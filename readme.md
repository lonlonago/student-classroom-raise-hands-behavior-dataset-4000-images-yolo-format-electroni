# Student Classroom Raise Hands Behavior Dataset 4000 Images Yolo Format Electronic Resource

# Body

Student Classroom Raise Hands Behavior Dataset, 4000 Images, Yolo Format, Electronic Data Files

The images are all scenes of classroom participation, suitable for projects related to target detection, behavior analysis, and computer vision. The dataset is comprehensive with complete annotations, allowing for direct training of models in the Yolo format, saving time and effort
